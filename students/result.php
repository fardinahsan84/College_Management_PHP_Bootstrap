              ...
              <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                  ...
                  <a href="http://localhost/College_Management_PHP_Bootstrap/students/assignment.php" class="nav-link">Assignment</a>
								...
								<li class="nav-item">
                  <a href="http://localhost/College_Management_PHP_Bootstrap/students/result.php" class="nav-link active">Result</a>
                </li>
              </ul>
            </div>
            <div class="card-body ">
		                ...
		                <table class="table">
			                ...
			                <table class="table">
				                ...
				                <table class="table table-borderless mt-5">
					                		...
					                		<th>Final Grade</th>
															<th ><?php echo gradeCalculate($mft,$ftf)."(".($mft+$ftf).")";?></th>
					                	</tr>
													</tbody>
				                </table>
											</div>
